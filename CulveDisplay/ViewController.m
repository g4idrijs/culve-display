...
@property (nonatomic , strong) CulveLive *refreshMoniterView;
@property (nonatomic , strong) CulveLive *translationMoniterView;
...
- (CulveLive *)translationMoniterView
{
    if (!_translationMoniterView) {
        CGFloat xOffset = 10;
        _translationMoniterView = [[CulveLive alloc] initWithFrame:CGRectMake(xOffset, CGRectGetMaxY(self.refreshMoniterView.frame) + 10, CGRectGetWidth(self.view.frame) - 2 * xOffset, 200)];
